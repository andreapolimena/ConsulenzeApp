...
public class ModificaDisponibilita extends AppCompatActivity {
        ...
        modifica.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!specializzazione.getText().toString().isEmpty() &&
                    ...
                    Toast.makeText(ModificaDisponibilita.this, "Disponibilità modificata correttamente", Toast.LENGTH_LONG).show();
                    Intent intent = new Intent(ModificaDisponibilita.this, Disponibilita.class);
